  ...
  for (jj in seq_len(iter)){
    ...
    if(jj==1){
      ...
      TP_Class <- colSums(tPred[
        which(testSetClasses == levels(testSetClasses)[1]),] == 1)
      TN_Class <- colSums(tPred[
        which(testSetClasses == levels(testSetClasses)[2]),] == 0)
      FP_Class <- colSums(tPred[
        which(testSetClasses == levels(testSetClasses)[1]),] == 0)
      FN_Class <- colSums(tPred[
        which(testSetClasses == levels(testSetClasses)[2]),] == 1)
